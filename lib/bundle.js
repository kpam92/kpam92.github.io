	...
	Game.prototype.moveObjects = function() {
	  ...
	  this.allObjects().forEach( function(asteroid) {
	    if ((asteroid.pos[0] < 0) || (asteroid.pos[1] > 800)) {
	      ...
	      that.addAsteroids(1, that.options.asteroid_color, that.options.vel);
	    } else {
	      asteroid.move();
	    }
	  });
...
/***/ function(module, exports, __webpack_require__) {
	...
	function GameView() {
	  this.game = new Game({game_view: this, num_asteroids: 500, asteroid_color: "pink", vel: [-4,4]});
